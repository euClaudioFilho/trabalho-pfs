...
const HomeDentista = () => {
  ...
  useEffect(() => {
    const fetchDados = async () => {
      try {
        const consultas = await consultaService.getConsultasDentista(usuario.dentistaId);
  ...
  return (
    <Container>
      <Card>
        ...
        <Subtitle>Sua agenda de consultas:</Subtitle>
        <List>
        ...
        <ButtonGroup>
          <ActionButton onClick={() => navigate("/gerenciarConsultas")}>
            Gerenciar Consultas
          </ActionButton>
